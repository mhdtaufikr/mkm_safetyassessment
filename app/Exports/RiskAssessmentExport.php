    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getColumnDimension('G')->setWidth(self::MEDIUM_WIDTH);
                ...
                $sheet->getColumnDimension('M')->setWidth(self::SMALL_WIDTH);
                ...
                $sheet->getStyle('A1:M2')->getAlignment()->setVertical('center');
                ...
                foreach ($this->data as $item) {
                    ...
                    // FINDING PROBLEM + accessor di kolom B
                    ...
                    // POTENTIAL HAZARDS + risk level di kolom C
                    ...
                    $runPotential->getFont()->setColor(new Color('000000'));
                    ...
                    $runRisk->getFont()->setColor(new Color($riskColor));
                    ...
                    // STATUS sekarang pindah ke kolom K
                    ...
                    $sheet->setCellValue("K{$row}", $richText);
