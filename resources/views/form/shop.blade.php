...
<head>
  ...
  <style>
    ...
    /* ── Inline validation ── */
    .invalid-feedback { display: none; font-size: 0.75rem; color: #dc2626; margin-top: 0.25rem; }
    ...
    .file-input::file-selector-button:hover { background: rgba(0,103,127,0.15); }
...
<body class="min-h-screen antialiased">
  ...
  <div id="submit-overlay">
    ...
    <div style="text-align:center;">
      <p class="text-white font-black text-lg tracking-wide">Submitting Assessment...</p>
  ...
  <div class="max-w-4xl mx-auto px-4 py-6 mb-10 relative z-10">
    ...
    <form id="risk-form"
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-3 mb-4">
        ...
        <button type="button"
                id="add-entry-btn"
                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 text-sm font-bold px-4 py-2 rounded-xl border-2 transition"
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateField(el) {
      ...
      if (!ok) {
        ...
        if (fb && fb.classList.contains('invalid-feedback')) {
          const label = el.closest('div')?.querySelector('label')?.textContent?.replace('*', '').trim() || 'This field';
    ...
    form.addEventListener('submit', function (e) {
      ...
      if (!accessorVal) {
        ...
        accessorInput.scrollIntoView({ behavior: 'smooth', block: 'center' });
        accessorInput.focus();
        return;
      }
