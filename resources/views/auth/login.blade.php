...
<head>
    ...
    <title>MKM Inventory System</title>
...
<body>
        ...
        <div class="picture-section">
            ...
            <div class="login-card">
                <div class="login-card-content">
                    <img src="" alt="Application Logo" style="height:60px; width:auto; margin-bottom: 20px;">
    ...
    <button type="button" class="btn btn-sm btn-sm btn-info  w-100 mb-2 text-white" data-bs-toggle="modal" data-bs-target="#requestAccessModal">Request Access</button>
</div>
