      ...
      <div class="card shadow-lg mb-4">
        ...
        <div class="card-body">
            ...
            <div class="col-md-4 col-12">
              ...
              <select name="shop" class="form-select" required>
                ...
                @foreach($shops as $shop)
                  <option value="{{ $shop->name }}" {{ old('shop', $audit->shop ?? '') == $shop->name ? 'selected' : '' }}>{{ $shop->name }}</option>
                @endforeach
              </select>
            </div>
            <div class="col-md-4 col-12">
          ...
          <div class="card border-primary mb-4">
            ...
            <div class="card-body">
              ...
              <div class="card mb-3 border-secondary shadow-sm" data-category="{{ $key }}">
                <div class="card-body">
                  <div class="row mb-3">
                    <div class="col-md-6"><strong>Check Item:</strong> {{ $item[0] }}</div>
                    <div class="col-md-6"><strong>Description:</strong> {{ $item[1] }}</div>
                  </div>
          ...
          <div class="mt-4">
            ...
            <a href="{{ route('saudit.index') }}" class="btn btn-secondary">Cancel</a>
          </div>
